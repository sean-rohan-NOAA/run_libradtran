...
# Lunar irradiance
lza_vec = list(range(0,132,1))
day_of_year = list(range(1,366, 10))
# phase = list(range(0,181))

def run_lunar_simulation(phase_list):
        ...
        for dd in day_of_year:
            ...
            for zz in lza_vec:
                ...
                make_input_file(
                    ...
                    extraterrestrial_spectrum_path=f"/home/seanr/libRadtran-2.0.4/data/lunar_flux/lunar_irrad{pp}_10nm",
                    ozone_du=300,
                    day_of_year=dd,
                    zenith_angle=zz,
                    rte_solver='mystic',
